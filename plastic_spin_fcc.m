...
sS = slipSystem.fcc(cs); % Define slip system (change from fcc to bcc if required)
...
sP = phi2Sections(cs,specimenSymmetry('222'),'phi2',[0 45 65]*degree,'resolution',1*degree);
